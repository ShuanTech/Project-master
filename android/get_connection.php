...
if(isset($_POST['u_id'])){
	...
	$data=array();
	$sql="SELECT l.u_id,l.full_name,l.pro_pic,l.level FROM `login` l,connection c WHERE l.u_id=c.connect 
		and c.u_id='".$_POST['u_id']."'";
	...
	if(mysql_num_rows($result)>0){
			...
			while($row=mysql_fetch_array($result)){
				...
				array_push($response["connection"],$data);
			}
				$response['success']=1;
