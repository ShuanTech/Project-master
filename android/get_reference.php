...
if(isset($_POST['u_id'])){
	...
	$data=array();
	$sql="select DISTINCT l.u_id,l.full_name,l.pro_pic,l.level from 
	login l,job_applied j WHERE j.applied_usr=l.u_id and j.refer_id='".$_POST['u_id']."'";
	...
	if(mysql_num_rows($result)>0){
			...
			while($row=mysql_fetch_array($result)){
				...
				array_push($response["refer"],$data);
			}
				$response['success']=1;
