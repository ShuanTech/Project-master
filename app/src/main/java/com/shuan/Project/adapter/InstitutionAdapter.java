 ...
 */
public class InstitutionAdapter extends ArrayAdapter<Sample> implements Filterable {
    ...
    public InstitutionAdapter(Context mContext, int resource, int txtId, ArrayList<Sample> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        insName.setText(curr.getInsName());
        univ.setText(curr.getBoard());
