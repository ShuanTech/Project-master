 ...
 * This Amenity caches pages by itself and provide getter method to the cache.
 */
public abstract class CacheFragmentStatePagerAdapter extends FragmentStatePagerAdapter {
     ...
     * {@inheritDoc}
     *
     * @param position position of the item in the Amenity
    ...
    /**
     * Get the item at the specified position in the Amenity.
     *
     * @param position position of the item in the Amenity
     * @return fragment instance
     */
     ...
     *
     * @param index index of the item in the Amenity
