 ...
 */
public class AppliedFragment extends Fragment implements AbsListView.OnScrollListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView.setText("No Jobs Applied");

        list = new ArrayList<Sample>();

        new GetPost(getActivity(), listView, progressBar,textView, mApp.getPreference().getString(Common.u_id,""),"applied",swipe).execute();
