...
/**
 * Created by Android on 17-Aug-17.
 */

public class YearPicker1 {
     ...
     *            the activity
     */
    public YearPicker1(Activity activity) {
        this.activity = activity;
        this.view = activity.getLayoutInflater().inflate(R.layout.year_picker_view, null);
    }
